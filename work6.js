    ...
    render() {
        return (
            <Card style={{ borderColor: '#e9299f' }}>
                ...
                <Card.Body>
                    <Button onClick={() => this.readData()} style={{ backgroundColor: '#e756b0', color: 'white', borderColor: '#e9299f' }}>Read Data</Button>{"\u00A0"}
                    <Button onClick={() => this.autoRead()} style={{ backgroundColor: '#e756b0', color: 'white', borderColor: '#e9299f' }}>Auto Read</Button>
                    <div>
                ...
                <Card.Footer>
                    ...
                    <Button onClick={() => this.insertData()} style={{ backgroundColor: '#e756b0', color: 'white', borderColor: '#e9299f' }}>Save</Button>
                </Card.Footer>
